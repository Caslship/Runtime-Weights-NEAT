...
namespace SharpNeat.Utility
{
    ...
    public static class Utilities
    {
        ...
        /// <summary>
        /// Just put this here to get rid of 'Missing XML Comment' warnings (Jason Palacios)
        /// </summary>
        /// <param name="x"></param>
        /// <param name="metricThreshold"></param>
        /// <param name="metricMax"></param>
        /// <param name="fitnessThreshold"></param>
        /// <param name="fitnessMax"></param>
        /// <returns></returns>
